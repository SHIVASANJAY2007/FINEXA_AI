...
// High-quality SVG Finance-Only Icons matching the reference image
const IconLineGraph = memo(({ accent }) => (
...
const IconReportMoneyBag = memo(({ accent }) => (
...
const IconBarChartArrow = memo(({ accent }) => (
    <svg width="50" height="50" viewBox="0 0 48 48" fill="none" stroke={accent ? "#38bdf8" : "#8b7e74"} strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
...
const IconPieChart = memo(({ accent }) => (
    <svg width="50" height="50" viewBox="0 0 48 48" fill="none" stroke={accent ? "#38bdf8" : "#8b7e74"} strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
...
const IconReportPen = memo(({ accent }) => (
    <svg width="50" height="50" viewBox="0 0 48 48" fill="none" stroke="#8b7e74" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
...
const IconCurvedArrowChart = memo(() => (
    <svg width="50" height="50" viewBox="0 0 48 48" fill="none" stroke="#8b7e74" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
...
const IconCoinStack = memo(({ accent }) => (
    <svg width="50" height="50" viewBox="0 0 48 48" fill="none" stroke={accent ? "#38bdf8" : "#8b7e74"} strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
...
const IconHandCoin = memo(({ accent }) => (
    <svg width="50" height="50" viewBox="0 0 48 48" fill="none" stroke={accent ? "#38bdf8" : "#8b7e74"} strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none select-none z-0 bg-[#FDF8F3]">
                ...
                {PATTERN_ROWS.map((row, rowIndex) => (
                    ...
                    >
                        {row.map((item, colIndex) => {
                            ...
                            const duration = 4 + (uniqueIndex % 4) * 1.2;
                            const delay = (uniqueIndex % 5) * 0.3;

                            return (
                                <div
                                    key={colIndex}
                                    style={{
                                        animation: `iconFloat ${duration}s ease-in-out ${delay}s infinite alternate`,
            ...
            <style>{`
                @keyframes iconFloat {
                    ...
                    50% {
                        transform: translate3d(0, -6px, 0) rotate(2deg) scale(1.03);
                    }
                    100% {
                        transform: translate3d(0, 6px, 0) rotate(-2deg) scale(0.97);
                    }
                }
            `}</style>
        </div>
...
export default memo(AnimatedIconBackground);
