...
const Features = () => {
    ...
    return (
        <section
            id="features"
            ref={sectionRef}
            className="relative min-h-screen w-full bg-burgundy overflow-hidden flex flex-col items-center justify-center p-6 md:p-12"
        >
            ...
            <div className="w-full max-w-7xl mx-auto px-4 md:px-6 h-full flex flex-col items-center justify-center relative z-10 mt-6">
                {/* Header Area */}
                <div className="text-center mb-8">
                    <h2 ref={titleRef} className="text-ivory text-[clamp(2.8rem,6vw,7rem)] font-serif font-bold uppercase tracking-tight leading-[1] mt-6 select-none">
                        THE NEXT <br />
                        <TextType
                            text={['ERA', 'STEP', 'MOVE']}
                            className="text-gold"
                ...
                {/* STICKY SCROLL AREA */}
                <div className="w-full h-[68vh] rounded-[32px] border border-beige/20 bg-ivory/95 shadow-[0_20px_50px_rgba(58,46,37,0.25)] overflow-hidden">
                    <StickyScrollReveal content={content} />
                </div>

                {/* SCROLL HINT */}
                <div className="mt-6 flex flex-col items-center opacity-60 animate-bounce">
                    <span className="text-ivory font-semibold text-[9.5px] tracking-widest uppercase">Syncing Wealth Nodes</span>
                    <span className="text-ivory text-base mt-0.5">↓</span>
                </div>
            </div>
        </section>
    );
